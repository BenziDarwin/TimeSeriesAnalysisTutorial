...
\noindent\textbf{Background.} Fine particulate air pollution is an important environmental health concern, but evidence based on routinely collected morbidity data in East African cities remains limited. This chapter examined weekly associations between ambient \pmfive{} concentrations and respiratory morbidity outcomes (TB, ILI, severe pneumonia under five, SARI, and Total Respiratory Diseases) in Kampala, Uganda.\\
...
\noindent\textbf{Results.} For Total Respiratory Diseases pooled across all diagnoses, a 10 \ugm{} higher \pmfive{} concentration was associated with a 4.3\% higher notification count (IRR 1.043, 95\% CI 1.002--1.086; $p=0.041$). The primary outcome-specific model associated a 10 \ugm{} higher \pmfive{} concentration with higher ILI notifications (IRR 1.173, 95\% CI 1.030--1.335), whereas SARI and under-five pneumonia estimates were imprecise and the inverse TB estimate was not interpreted as protective. In the harmonised weekly lag analysis, ILI was higher at one-week lag (IRR 1.327, 1.086--1.621); results varied by lag and outcome. Of the medical-review records, 3,632 had same-day division-level exposure assignment. Within-division \pmfive{} associations with recorded case rates were near null (Total Respiratory Diseases IRR 1.022, 0.996--1.048; TB IRR 1.001, 0.978--1.024); the diagnosis case-mix analysis nevertheless showed higher odds of ILI versus other reviewed respiratory diagnoses (OR 1.749, 1.490--2.053).\\
\noindent\textbf{Conclusions.} Routine data revealed positive associations between \pmfive{} and total respiratory disease morbidity as well as outcome-specific ILI, but the ecological design, incomplete control of confounding, exposure aggregation, and surveillance artifacts preclude causal attribution. The findings support improved integrated environmental and health surveillance and prospective, pre-specified studies.
...
Total Respiratory Diseases & 1322.45 & 818.59 & 17.00 & 993.50 & 5156.00 \\
\bottomrule
\end{tabular}
\end{table}
...
In the primary adjusted Poisson models, Total Respiratory Diseases exhibited a positive and statistically significant association with ambient particulate pollution (Table~\ref{tab:primary}; Figure~\ref{fig:primary}). A 10 \ugm{} higher weekly \pmfive{} concentration was associated with a 4.3\% higher notification count for Total Respiratory Diseases (IRR 1.043, 95\% CI 1.002--1.086; $p=0.041$; AIC 45027.3). Among individual diagnoses, ILI was the only specific outcome with a positive association whose 95\% CI excluded the null, with a 10 \ugm{} higher \pmfive{} concentration associated with 17.3\% higher ILI notifications (IRR 1.173, 95\% CI 1.030--1.335; $p=0.016$). The estimate for SARI was positive but imprecise (IRR 1.038, 95\% CI 0.950--1.135). The under-five severe pneumonia estimate was below one but compatible with the null (IRR 0.956, 95\% CI 0.908--1.005). The inverse TB estimate was statistically precise but biologically and methodologically ambiguous; it reflects surveillance artifacts, diagnostic delays, and care-seeking disruptions rather than any protective effect.
...
Total Respiratory Diseases & 1.043 & 1.002--1.086 & 0.041 & 45027.3 \\
\bottomrule
\end{tabular}
...
The 0--4-week cumulative association was positive for Total Respiratory Diseases (IRR 1.080, 95\% CI 1.022--1.141) and for ILI (IRR 1.192, 95\% CI 1.032--1.377), whereas it remained compatible with the null for TB (0.977, 0.952--1.002), severe pneumonia (0.969, 0.903--1.039), and SARI (1.043, 0.951--1.144) (Figure~\ref{fig:lag}). No single lag pattern by itself supplies strong evidence of a uniform exposure response across all individual sub-categories, but the cumulative burden indicates sustained elevated respiratory morbidity during multivariable weekly exposure.
...
The integration of the official Uganda Parish Shapefile enabled high-resolution spatial exposure assessment across all 95 administrative parishes of Greater Kampala (Figure~\ref{fig:map}). Continuous \pmfive{} estimates derived via inverse distance weighting (IDW) from the calibrated AirQo monitor network ranged from 32.55 \ugm{} in Makerere University / Wandegeya to 52.31 \ugm{} in Kasubi (Rubaga) and 51.42 \ugm{} in Bwaise (Kawempe), delineating fine-scale intra-urban pollution gradients. In the temporally linked medical-record panel, division mean exposures ranged from 32.26 \ugm{} in Nakawa to 58.96 \ugm{} in Rubaga. The linked panel included 5,006 eligible records, of which 3,632 had same-day division \pmfive{} assignment; monitoring density varied from one to 2.46 mean active sites by division. The largest number of linked records was in Rubaga (1,175), followed by Nakawa (1,077) and Makindye (953). Resolving patient residence to official parish boundaries linked 3,858 cases (76.8\%) to specific parish polygons, highlighting localized clusters in Mutundwe (417 cases), Mutungo (283 cases), and Salaama (242 cases). These quantities reflect the reviewed facility record source and its residence reporting, not community disease incidence.

In weekly division--time rate models, within-division PM variation was not estimated precisely for Total Respiratory Diseases (IRR 1.022 per 10 \ugm{}, 95\% CI 0.996--1.048; $N=1580$ strata), ILI (IRR 1.090, 95\% CI 0.966--1.230), pneumonia (1.060, 0.995--1.128), severe acute respiratory infection (0.958, 0.864--1.062), or TB (1.001, 0.978--1.024) (Table~\ref{tab:spatial-rate}). The small severe-pneumonia stratum had insufficient observations to support a stable model. In the secondary diagnosis case-mix analysis, higher \pmfive{} was associated with higher odds of ILI versus the other reviewed diagnoses (OR 1.749, 1.490--2.053) and lower odds of TB (0.848, 0.779--0.923). These case-mix associations do not estimate occurrence of RTI in the population and should not be interpreted as causal or as substitutes for the rate models.
...
Total Respiratory Diseases & 1,580 & 1.022 & 0.996--1.048 \\
\bottomrule
\end{tabular}
\begin{flushleft}\footnotesize
...
\caption{High-resolution \pmfive{} exposure across the 95 administrative parishes of Greater Kampala derived via AirQo network inverse distance weighting (IDW), overlaid with primary division boundaries.}
\label{fig:map}
\end{figure}

\section{Sensitivity analysis}
The positive associations for Total Respiratory Diseases and ILI remained stable across both sensitivity specifications (Table~\ref{tab:sensitivity}). For Total Respiratory Diseases, the estimated IRR was 1.060 (95\% CI 1.005--1.117) after trimming extreme pollution weeks and 1.051 (95\% CI 1.010--1.093) with a one-week exposure lag. The TB association attenuated toward the null with a one-week exposure lag. The remaining outcomes remained non-significant. These checks demonstrate within-model stability across exposure truncations and timing specifications, while reinforcing that unmeasured temporal confounding and diagnostic variability remain key interpretive caveats.
...
Total Respiratory Diseases & Primary & 248 & 1.043 & 1.002--1.086 \\
Total Respiratory Diseases & Exclude highest 5\% & 235 & 1.060 & 1.005--1.117 \\
Total Respiratory Diseases & One-week lag & 247 & 1.051 & 1.010--1.093 \\
\bottomrule
\end{tabular}
\end{table}
...
The primary analysis identified a statistically significant positive association between weekly ambient \pmfive{} and notifications of Total Respiratory Diseases (IRR 1.043, 95\% CI 1.002--1.086), alongside a strong positive association with ILI notifications (IRR 1.173, 95\% CI 1.030--1.335). The cumulative 0--4-week distributed lag model likewise demonstrated sustained elevated risk for Total Respiratory Diseases (cumulative IRR 1.080, 95\% CI 1.022--1.141). The harmonised re-analysis retained positive ILI estimates at selected weekly and monthly lags, but the direction and precision varied across individual outcome categories. The division-level recorded-case rate models showed an estimated IRR of 1.022 (95\% CI 0.996--1.048) for Total Respiratory Diseases. Taken together, the findings are compatible with a short-term increase in aggregate respiratory morbidity during weeks of elevated particulate pollution, although the observational and ecological design cannot establish causal attribution.
...
\section{Strengths}
Strengths include a multiyear weekly series, explicit linkage of environmental and surveillance sources, multiple respiratory outcomes, aggregate Total Respiratory Diseases modeling, lag analyses, and transparent sensitivity checks. The updated work adds a non-imputed canonical time-series sensitivity pipeline, a documented medical-record selection flow, same-day division-level exposure assignment, sex- and age-stratified recorded-case rates, population denominators, and explicit reporting of unresolved parish linkage. The chapter also distinguishes exploratory analyses from primary inference and retains the complete no-mortality analytic scope.
...
\chapter{Conclusion}
Across the primary 248-week series and canonical sensitivity pipelines, positive \pmfive{} associations emerged for Total Respiratory Diseases (IRR 1.043, 95\% CI 1.002--1.086) and ILI (IRR 1.173, 95\% CI 1.030--1.335), supported by cumulative distributed lag effects. Associations for SARI and under-five pneumonia were imprecise, while inverse TB estimates are not plausibly interpretable as protection. The spatial medical-record analysis provided division, sex, age, and population-standardized rate context, finding consistent but imprecise within-division rate associations for Total Respiratory Diseases (IRR 1.022, 0.996--1.048). These findings provide consistent observational evidence of particulate-related respiratory morbidity in Greater Kampala, highlighting the critical necessity of integrated urban air-quality policies, expanded monitoring infrastructure, and pre-specified prospective epidemiological cohorts.
